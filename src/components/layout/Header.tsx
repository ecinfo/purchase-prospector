...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div className="flex items-center justify-between px-4 h-14 sm:h-16 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            className={`
              hidden sm:flex items-center gap-2 px-3 py-2 rounded-lg transition-all border
              ${
                searchFocused
                  ? "border-blue-500 ring-2 ring-blue-200 bg-white dark:bg-gray-800 dark:ring-blue-800"
                  : "border-gray-300 bg-gray-50 hover:bg-white hover:border-gray-400 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:border-gray-600"
              }
            `}
          >
            ...
            />
            {/* KBD shortcut */}
            <kbd className="hidden lg:inline-flex items-center px-1.5 py-0.5 text-xs text-gray-400 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600">
              ⌘K
            </kbd>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            ...
            <ChevronDown className="hidden w-4 h-4 text-gray-400 dark:text-gray-500 md:block" />
          </button>
        </div>
      </div>

        ...
        setVendors((prev) =>
          prev.map((v, idx) => {
            if (idx === i) {
              return {
                ...v,
                status: v.id === "4" ? "declined" : "interested",
              };
            }
            return v;
          })
    ...
    <div className="min-h-screen p-4 bg-gray-50 dark:bg-gray-900 md:p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="p-6 mb-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-4 text-sm leading-relaxed text-gray-700 border-l-4 border-blue-500 rounded-md dark:text-gray-300 bg-gray-50 dark:bg-gray-800">
            <p className="mb-2">
              <strong>
        ...
        {isSimulating ? (
          <div className="p-6 mb-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-5 h-5 border-2 border-blue-600 rounded-full dark:border-blue-400 border-t-transparent animate-spin" />
              <span className="font-medium text-gray-900 dark:text-gray-200">
                Calling Vendors...
              </span>
            </div>
            <div className="relative w-full h-2 overflow-hidden bg-gray-200 rounded-full dark:bg-gray-700">
              <div
                className="absolute top-0 left-0 h-full transition-all duration-500 bg-gray-900 dark:bg-blue-500"
          ...
          <div className="p-6 mb-6 border border-green-200 rounded-lg dark:border-green-800 bg-green-50 dark:bg-green-900">
            <div className="flex items-center gap-3">
              <CheckCircle className="flex-shrink-0 w-5 h-5 text-green-600 dark:text-green-300" />
              <div>
          ...
          <div className="p-6 mb-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="space-y-3">
              {vendors.map((vendor) => (
                <div
                  key={vendor.id}
                  className="p-4 transition-colors border border-gray-200 rounded-lg dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600"
                >

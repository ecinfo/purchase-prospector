...
export const RecentProjects: React.FC = () => {
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default:
        return (
          <FileEdit className="w-4 h-4 text-gray-400 dark:text-gray-500" />
        );
    }
  };
  ...
  const getStatusStyles = (status: string) => {
    switch (status) {
      ...
      default:
        return "bg-gray-100 text-gray-600 dark:bg-gray-800/40 dark:text-gray-300";
    }
  };
    ...
    <Card className="h-full dark:bg-gray-900 dark:border-gray-700">
      ...
      <CardContent className="space-y-3">
        {recentProjects.map((project) => (
          <div
            key={project.id}
            className="flex flex-col justify-between gap-3 p-4 transition-all rounded-lg  sm:flex-row sm:items-center bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <div className="flex items-center gap-3">
              <div className="p-2 bg-white border rounded-lg shrink-0 dark:bg-gray-700 dark:border-gray-600">
        ...
        {/* Performance Summary */}
        <div
          className="p-4 mt-4 border border-blue-200 rounded-lg  bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 dark:border-blue-900/40"
        >
